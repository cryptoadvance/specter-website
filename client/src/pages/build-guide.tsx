        ...
        <header className="mb-12 text-center">
          ...
          <div className="mt-6 text-center text-gray-400 max-w-2xl mx-auto">
            ...
            <ul className="mt-4 list-disc list-inside space-y-1 mx-auto max-w-fit">
              <li><a href="https://github.com/cryptoadvance/specter-diy/blob/master/docs/shopping.md" target="_blank" className="text-specter-primary hover:underline">Shopping Guide</a></li>
