        ...
        <ul className="list-none text-gray-300 space-y-8" id="parts-list">
          <li id="part-developer-board" data-cases="specter-diy specter-shield specter-shield-lite specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://eu.mouser.com/ProductDetail/STMicroelectronics/STM32F469I-DISCO?qs=kWQV1gtkNndotCjy2DKZ4w%3D%3D" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Mouser</a></li>
              <li><a href="https://de.rs-online.com/web/p/entwicklungstools-microcontroller/9092865" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">RS-Online</a></li>
              <li><a href="https://www.digikey.com/en/products/detail/stmicroelectronics/STM32F469I-DISCO/5428811" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Digi-Key</a></li>
            </ul>
          </li>
          ...
          <li id="part-gm65-scanner-board" data-cases="specter-diy">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.waveshare.com/barcode-scanner-module.htm" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Waveshare</a></li>
              <li><a href="https://www.sunsky-online.com/de/p/ZY14328032/Waveshare-Barcode-Scanner-Module-1D-2D-Codes-Reader.htm" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Sunsky-Online</a></li>
            </ul>
          </li>
          ...
          <li id="part-gm65-scanner" data-cases="specter-shield specter-shield-lite specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.alibaba.com/product-detail/Original-GM65-S-Barcode-QR-Code_1601114566992.html?spm=a2700.galleryofferlist.normal_offer.d_image.51f213a0IJ52CF&priceId=aecebae476e543e7aaebb0c257c58836" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Alibaba</a></li>
              <li><a href="https://de.aliexpress.com/item/33008958186.html?spm=a2g0o.productlist.main.8.3abc2cc23LfGCp&algo_pvid=859a7d84-4e23-4bb6-9133-d65418377045&pdp_ext_f=%7B%22order%22%3A%227%22%2C%22eval%22%3A%221%22%7D&utparam-url=scene%3Asearch%7Cquery_from%3A%7Cx_object_id%3A33008958186%7C_p_origin_prod%3A" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">AliExpress</a></li>
              <li><a href="https://cryptoguide.tips/product/gm65-barcode-scanner/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Cryptoguide.tips</a></li>
            </ul>
          </li>
          ...
          <li id="part-m3y-scanner" data-cases="specter-shield-lite specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.alibaba.com/product-detail/M3Y-W-OEM-Barcode-Scan-Module_1601368712449.html?spm=a2756.trade-list-buyer.0.0.374776e9PKaVPA" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Alibaba</a></li>
            </ul>
          </li>
          ...
          <li id="part-pins" data-cases="specter-diy">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://eu.mouser.com/ProductDetail/Samtec/DW-02-10-T-S-571?qs" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Mouser</a></li>
              <li><a href="https://www.amazon.com/gp/product/B015KA0RRU/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Amazon</a></li>
            </ul>
          </li>
          ...
          <li id="part-specter-shield-board" data-cases="specter-shield">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.pcbway.com/project/shareproject/Specter_Shield_v1_0_0_2024_Update_ea6f25c5.html" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">PCBWay</a></li>
              <li><a href="https://cryptoguide.tips/product/specter-shield-board/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Cryptoguide.tips</a></li>
              <li><a href="https://clavastack.com/produkt/specter-shield-board/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack</a></li>
            </ul>
          </li>
          ...
          <li id="part-specter-shield-lite-board" data-cases="specter-shield-lite specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.pcbway.com/project/shareproject/Specter_Shield_Lite_ad02f25b.html" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">PCBWay</a></li>
              <li><a href="https://cryptoguide.tips/product/specter-shield-lite-board/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Cryptoguide.tips</a></li>
              <li><a href="https://clavastack.com/produkt/specter-shield-lite-board/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack</a></li>
            </ul>
          </li>
          ...
          <li id="part-smart-card" data-cases="specter-shield specter-shield-lite specter-shield-lite-battery">
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-4">
                <li><a href="https://cryptoguide.tips/product/j3h145-javacard/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Cryptoguide.tips</a></li>
                <li><a href="https://clavastack.com/produkt/smartcard/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack</a></li>
                <li><a href="https://clavastack.com/produkt/smartcard/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack (printed)</a></li>
              </ul>
            </div>
            <div className="mt-4">
              <h4 className="font-semibold text-lg text-gray-200">Raw:</h4>
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-4">
                <li><a href="https://www.alibaba.com/product-detail/J3H145-JCOP3-SecID-P60-JavaCard-Contact_1600717536549.html" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Alibaba</a></li>
                <li><a href="https://de.aliexpress.com/item/1005001306297920.html" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">AliExpress</a></li>
              </ul>
            </div>
          </li>
          ...
          <li id="part-rechargeable-battery" data-cases="specter-shield">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.amazon.de/dp/B095YC5PW8" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Amazon.de</a></li>
            </ul>
          </li>
          ...
          <li id="part-usb-c-module" data-cases="specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://de.aliexpress.com/item/1005007510399629.html?gatewayAdapt=usa2deu4itemAdapt" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">AliExpress</a></li>
            </ul>
          </li>
          ...
          <li id="part-switch" data-cases="specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://de.aliexpress.com/item/10000003088863.html?gatewayAdapt=usa2deu4itemAdapt" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">AliExpress</a></li>
            </ul>
          </li>
          ...
          <li id="part-contact-springs" data-cases="specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://de.aliexpress.com/item/1005005681174972.html?gatewayAdapt=usa2deu4itemAdapt" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">AliExpress</a></li>
            </ul>
          </li>
          ...
          <li id="part-screws-shield" data-cases="specter-shield">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://www.amazon.de/Drenky-Senkkopfschrauben-Gewindeschrauben-Steckdosen-Regelgewinde/dp/B0CN6CLQT1/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Amazon.de</a></li>
              <li><a href="https://de.aliexpress.com/item/1005004020339065.html" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">AliExpress</a></li>
            </ul>
          </li>
          ...
          <li id="part-screws-lite" data-cases="specter-shield-lite specter-shield-lite-battery">
            ...
            <ul className="list-disc list-inside text-specter-primary space-y-1">
              <li><a href="https://1aschrauben.de/SPAX-Senkkopf-Kreuzschlitz-Z-kleiner-Kopf-Vollgewinde-YELLOX-A2L-PZ1-3x10-1000-Stk" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">10mm - 1aschrauben.de</a></li>
              <li><a href="https://1aschrauben.de/SPAX-Senkkopf-Kreuzschlitz-Z-kleiner-Kopf-Vollgewinde-YELLOX-A2L-PZ1-3x12-1000-Stk" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">12mm - 1aschrauben.de</a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <div className="mt-4" data-cases="specter-diy" id="case-specter-diy">
              ...
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-8">
                <li><a href="https://github.com/cryptoadvance/specter-diy/tree/master/docs/enclosures/snapcase" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">GitHub</a></li>
              </ul>
              <h5 className="font-semibold text-md text-gray-300 ml-4 mt-2">Buy:</h5>
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-8">
                <li><a href="https://bitcoin-store.org/products/specter-diy?variant=48150933045560" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Bitcoin Store</a></li>
                <li><a href="https://clavastack.com/en/product/einzelteil-snapcase-fuer-specter-diy/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack</a></li>
              </ul>
            </div>
            ...
            <div className="mt-4" data-cases="specter-shield-lite" id="case-specter-shield-lite">
              ...
              <h5 className="font-semibold text-md text-gray-300 ml-4">Print Files:</h5>
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-8">
                <li><a href="https://www.printables.com/model/1054878-specter-shield-lite-case/comments" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Printables.com</a></li>
              </ul>
              <h5 className="font-semibold text-md text-gray-300 ml-4 mt-2">Buy:</h5>
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-8">
                <li><a href="https://cryptoguide.tips/product/specter-shield-lite-case/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Cryptoguide.tips</a></li>
                <li><a href="https://clavastack.com/en/product/specter-shield-lite-case/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack</a></li>
              </ul>
            </div>
            ...
            <div className="mt-4" data-cases="specter-shield" id="case-specter-shield">
              ...
              <h5 className="font-semibold text-md text-gray-300 ml-4">Print Files:</h5>
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-8">
                <li><a href="https://github.com/cryptoadvance/specter-diy/tree/master/shield/Alternative_3D_Printed_Case" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">GitHub</a></li>
              </ul>
              <h5 className="font-semibold text-md text-gray-300 ml-4 mt-2">Buy:</h5>
              <ul className="list-disc list-inside text-specter-primary space-y-1 ml-8">
                <li><a href="https://clavastack.com/produkt/specter-shield-case/" target="_blank" rel="noopener noreferrer" className="text-specter-primary hover:underline">Clavastack</a></li>
              </ul>
            </div>
          </li>
        </ul>
